...
class Canvas(QtWidgets.QWidget):
    ...
    def mouseMoveEvent(self, ev):
        ...
        if self.drawing():
            ...
            if self.createMode == "polygon":
                ...
                self.line[1] = pos
            elif self.createMode == "linestrip" and ev.buttons() and QtCore.Qt.LeftButton:
    ...
    def mouseReleaseEvent(self, ev):
        ...
        #dainn edited
        elif ev.button() == QtCore.Qt.LeftButton and self.createMode == "linestrip":
            self.drawing_pen = False
            # self.finalise()
